...
contract PetalTokenV2 is Initializable, ERC20Burnable, Ownable, ReentrancyGuard {
    ...
    address private petalFactory;
    address public immutable treasury;
    address public pair;
    bool public pairBlocked;
    uint256 public immutable swapThreshold = 10_000 * 10**decimals();
    ...
    constructor(address _router) Ownable(msg.sender) ERC20("PETAL", "PETAL") {
...
function _update(address from, address to, uint256 value) internal virtual override {
    ...
    bool launched = IPetalV2Factory(petalFactory).tokenLaunched(address(this));
    if (!launched || inSwap) {
        super._update(from, to, value);
        return;
    }
